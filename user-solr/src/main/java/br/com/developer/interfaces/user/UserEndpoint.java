...
@RequestMapping(path = "/user", produces = MediaType.APPLICATION_JSON_VALUE, consumes = {
        MediaType.APPLICATION_JSON_VALUE }, headers = "content-type=application/x-www-form-urlencoded")
public class UserEndpoint {
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/{document}", produces = MediaType.APPLICATION_JSON_VALUE, consumes = {
            MediaType.APPLICATION_JSON_VALUE })
    public @ResponseBody ResponseEntity<?> findByDocument(@PathVariable("document") final String document,
